...
{
    public class ConsumerSetStatusProfile : BackgroundService
    {
        ...
        private readonly ILogger<ConsumerSetStatusProfile> _logger;

        public ConsumerSetStatusProfile(IServiceScopeFactory scopeFactory, IConfiguration configuration, ILogger<ConsumerSetStatusProfile> logger)
        {
        ...
        private void InitRabbitMQ()
        {
            try
            {
                ...
                channel.QueueDeclare(queue: RabbitQueue.SET_STATUS_PROFILE, durable: false,
                    exclusive: false, autoDelete: false, arguments: null);
                channel.BasicQos(0, 1, false);
                consumer = new EventingBasicConsumer(channel);
                channel.BasicConsume(queue: RabbitQueue.SET_STATUS_PROFILE,
