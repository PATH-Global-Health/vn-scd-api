...
namespace Services.RabbitMQ
{
    ...
    public interface IProducerDeleteUser : IDisposable
    {
        string DeleteUser(string message);
        void Close();
    }

    public class ProducerDeleteUser: IProducerDeleteUser
    {
        ...
        public ProducerDeleteUser(IConfiguration configuration)
        {
            _configuration = configuration;
            _factory = new ConnectionFactory();
            _configuration.Bind("RabbitMqConnection", _factory);
            _factory.ClientProvidedName = "DeleteUser";
        ...
        public string DeleteUser(string message)
        {
            try
            {
                ...
                channel.BasicPublish(
                    exchange: "",
                    routingKey: RabbitQueue.DELETE_USER,
